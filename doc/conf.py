...
sys.path.insert(1, "..")
import pyzotplus
from pyzotplus import zotero as zot
...
html_context = {
    ...
    "github_repo": "pyzotplus",  # Repo name
...
man_pages = [("index", "pyzotplus", "Pyzotplus Documentation", [author], 1)]
